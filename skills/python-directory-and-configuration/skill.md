...
- [Python Testing Excellence](../python-testing-excellence/skill.md) - For testing setup
- [Python with Async Code](../python-with-async-code/skill.md) - For async project setup
