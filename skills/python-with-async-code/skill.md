...
- Synchronous code → See [python-clean-implementation](../python-clean-implementation/skill.md)
- Testing patterns → See [python-testing-excellence](../python-testing-excellence/skill.md)
...
- [Python Clean Implementation](../python-clean-implementation/skill.md) - For sync implementation patterns
- [Python Testing Excellence](../python-testing-excellence/skill.md) - For testing async code
