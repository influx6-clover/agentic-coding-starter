...
- Synchronous code → See [rust-clean-implementation](../implementation/skill.md)
- Testing patterns → See [rust-testing-excellence](../testing/skill.md)
...
**For CPU-bound algorithms and performance patterns, see [Performance Tips](../implementation/skill.md#performance-tips).**
...
**For synchronous mutex patterns, see [Smart Pointer Usage](../implementation/skill.md#smart-pointer-usage).**
...
- [Rust Clean Implementation](../implementation/skill.md) - For sync implementation patterns
- [Rust Testing Excellence](../testing/skill.md) - For testing async code
