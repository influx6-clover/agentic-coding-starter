...
- Testing → See [rust-testing-excellence](../testing/skill.md)
...
**See also:** [Test Helper Functions](../testing/skill.md#test-helper-functions) for when `.unwrap()` is acceptable in test utilities.
...
**For async code:** See [Pitfall 3: Holding Locks Across Await Points](../async/skill.md#pitfall-3-holding-locks-across-await-points) for complete guidance on async-safe mutex usage.
...
- [Rust Testing Excellence](../testing/skill.md) - For writing tests
- [Rust with Async Code](../async/skill.md) - For async/await patterns
- [Rust Directory Setup](../directory-and-configuration/skill.md) - For project setup
