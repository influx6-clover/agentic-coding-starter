...
3. **Read specification files** (start.md, requirements.md, LEARNINGS.md, progress.md)
4. **Generate compacted.md** for current task (see context-compaction skill):
   - Use pipe-delimited compression
   - Include only current task information
...
1. **Launch implementation agents** (up to 10 concurrent)
   - Provide compacted.md path (or instruction to generate it)
...
Context:
- compacted.md: Generated by agent or provided by Main Agent
- Specification: specifications/[spec]/start.md, requirements.md, LEARNINGS.md
- Language skills: .agents/skills/[language]-clean-code/skill.md

After reading your documentation and context:
1. Read compacted.md (self-contained with all task info)
2. Read files listed in compacted.md FILES section
