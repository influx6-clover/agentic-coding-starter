...
- [Python Django Models](../models/skill.md) - For model configuration
- [Python Testing Excellence](../../testing/skill.md) - For testing config
- [Python Directory and Configuration](../../directory-and-configuration/skill.md) - For project setup
