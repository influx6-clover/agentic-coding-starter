...
- [Python gRPC Services](../grpc/services/skill.md) - For service implementation
- [Python gRPC Protobuf](../grpc/protobuf/skill.md) - For protobuf patterns
- [Python Django Models](../django/models/skill.md) - For Django patterns
